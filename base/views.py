...
def section3(request):
    inspiracijaes = Inspiracija.objects.all()
    shuffled_inspiracijaes = list(inspiracijaes)
    random.shuffle(shuffled_inspiracijaes)
    context = {'inspiracijaes': shuffled_inspiracijaes[:3]}
    return render(request, 'section3.html', context)
